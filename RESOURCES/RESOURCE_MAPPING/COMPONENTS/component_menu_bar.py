COMPONENT_MENU_BAR = {
    "IMAGE_MATOMO_LOGO": "css:#mega-menu-item-36503 img.mega-menu-logo",
    "BUTTON_MENU_WHY_MATOMO": "xpath://li[@id='mega-menu-item-36504']/a[@class='mega-menu-link'][contains(text(),'Why Matomo')]",
    "BUTTON_SUB_MENU_PRODUCT_FEATURES": "css:#mega-menu-item-36504 .mega-sub-menu #mega-menu-item-54921",
